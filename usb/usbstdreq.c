...
static unsigned char bConfiguration = 0;                       /** Currently selected configuration */
static TFnHandleRequest *pfnHandleCustomReq = NULL; /** Installed custom request handler */
static const unsigned char *pabDescrip = NULL;                 /** Pointer to registered descriptors */
...
int usbGetDescriptor(unsigned short wTypeIndex,
        unsigned short wLangID __attribute__ ((unused)),
...
//
static int usbHandleStdDeviceReq(TSetupPacket *pSetup, int *piLen, unsigned char **ppbData)
{
...
//
static int usbHandleStdInterfaceReq(TSetupPacket  *pSetup, int *piLen, unsigned char **ppbData)
{
    unsigned char *pbData = *ppbData;
...
// 
static int usbHandleStdEndPointReq(TSetupPacket *pSetup, int *piLen, unsigned char **ppbData)
{
    unsigned char *pbData = *ppbData;
